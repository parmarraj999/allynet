...
import ProfileMenu from '../../page/alumni-page/alumni-detail-page/popup/popup';
    ...
    <nav className="navbar">
      ...
      {!postHideNavbar && !eventHideNavbar && !libraryHideNavbar && !courseHideNavbar && !hideNavbarRoutes.includes(pathname) && (
        <div className='mobile-navbar' >
          {/* home route  */}
          <Link to='/' className={pathname === '/' ? 'mobile-navbar-item active' : 'mobile-navbar-item'}>
          ...
          {/* resource route  */}
          <Link to='/library' className={pathname === '/library' ? 'mobile-navbar-item active' : 'mobile-navbar-item'} >
          ...
          {/* alumni route  */}
          <Link to='/alumni' className={pathname === '/alumni' ? 'mobile-navbar-item active' : 'mobile-navbar-item'} >
          ...
          {/* course route  */}
          <Link to='/courses' className={pathname === '/courses' ? 'mobile-navbar-item active' : 'mobile-navbar-item'} >
          ...
          {/* event route  */}
          <Link to='/events' className={pathname === '/events' ? 'mobile-navbar-item active' : 'mobile-navbar-item'} >
          ...
          {/* <div className={pathname === '/' ? 'mobile-navbar-item active' : 'mobile-navbar-item'} >
